...
class ActionButtonBlue extends StatefulWidget {
  final String text;
  final VoidCallback function;
  final EdgeInsets paddingStart;
  final EdgeInsets paddingEnd;
  ...
  @override
  _ActionButtonBlueState createState() => _ActionButtonBlueState();
}

class _ActionButtonBlueState extends State<ActionButtonBlue>
    with SingleTickerProviderStateMixin {
  AnimationController _controller;
  Animation<double> _animOpac;
  Animation<double> _animTextOpac;
