  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedPadding(
        ...
        curve: Curves.easeIn,
        padding: processing ? spacer.x.xxl * 2.8 + spacer.y.xs : widget
            .paddingStart + spacer.y.xs,
        child: AnimatedContainer(
          padding: processing ? spacer.y.xs * 1.3 : spacer.y.xxs +
              spacer.top.xs * 0.5,
          decoration: BoxDecoration(
            color: processing ? DarkBlue : Green,
            borderRadius: BorderRadius.all(
                Radius.circular(processing ? 75 : 30)),
          ),
